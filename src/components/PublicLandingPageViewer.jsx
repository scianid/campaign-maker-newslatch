        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <div className="text-3xl font-bold text-gray-900">9.{Math.floor(Math.random() * 5) + 2}</div>
            ...
            <div className="text-right">
              <div className="text-sm text-gray-500 mb-1">Based on expert analysis</div>
              <div className="text-xs text-gray-400">{Math.floor(Math.random() * 1000) + 500}+ verified reviews</div>
            </div>
          </div>
          ...
          <div className="border-t pt-4">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>recommends this solution</span>
            </div>
          </div>
        </div>
